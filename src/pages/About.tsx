...
const milestones = [
  { date: '2026 Q1', event: '星火启航', desc: 'HamR 项目正式立项。确立了“五维家庭数据管理”核心理念，并完成基于 Web3 级数据加密与私有部署的核心技术选型。', active: true },
  { date: '2026 Q2', event: '品牌官网与公测', desc: '官方展示站 hamr.store 正式上线。核心代码托管至 GitHub，开启全球先锋家庭的封闭式公测。', active: true },
  { date: '2026 Q3', event: 'JiaBu AI 神经中枢', desc: '引入本地 AI 智能决策辅助系统。JiaBu 引擎上线，支持离线自然语言处理与多维家庭幸福感建模分析。', active: false },
  { date: '2026 Q4', event: '多端触达与开放网关', desc: '发布 iOS/Android 原生应用程序。开放智能硬件互联 API 网关，支持米家、HomeAssistant 等主流生态设备本地接入。', active: false },
]
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden" style={{ background: '#080616' }}>
      ...
      <div className="absolute top-0 right-1/3 w-[500px] h-[500px] bg-primary-500/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-[500px] h-[500px] bg-indigo-500/5 rounded-full blur-[150px] pointer-events-none" />

      {/* ── Hero 区域 ── */}
      <section className="relative py-golden-3xl z-10 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: 'easeOut' }}>
            <Heart className="w-12 h-12 mx-auto mb-6 text-primary-400 animate-pulse-slow filter drop-shadow-sm" />
            <div className="section-badge mb-golden-md">OUR MISSION & BRAND</div>
            <h1 className="text-display-sm md:text-display-xl font-extrabold text-white mt-2 mb-golden tracking-tight">
              让技术充满<span className="gradient-text font-black">家的温度</span>
            </h1>
            <p className="text-subheading text-primary-100/70 max-w-3xl mx-auto leading-relaxed font-medium">
      ...
      {/* ── 愿景与起因 (简洁与留白 / Whitespace & Simplicity) ── */}
      <section className="py-golden-2xl relative z-10 bg-white/[0.01]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="inline-flex p-3 rounded-2xl bg-white/5 border border-white/10 text-primary-300 mb-2">
              <Compass className="w-6 h-6 animate-spin-slow" />
            </div>
            
            <h2 className="text-3xl font-extrabold text-white tracking-tight">我们的起源与愿景</h2>
            
            <p className="text-base md:text-lg text-white/75 leading-relaxed font-medium text-left md:text-center">
      ...
      <section className="py-golden-2xl relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="section-badge">价值观</div>
            <h2 className="section-title">三项不妥协的价值观</h2>
            <p className="section-subtitle">我们在代码开发、功能规划及社区协作中严格遵循的安全原则</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-golden-md">
            {[
              ...
              >
                ...
                <div className={`inline-flex p-3 rounded-xl bg-white/5 border border-white/10 mb-5 transition-transform duration-300 group-hover:scale-110 ${v.color}`}>
                  {v.icon}
                </div>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-primary-300 transition-colors duration-200">{v.title}</h3>
                <p className="text-white/60 leading-relaxed text-sm font-semibold">{v.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-golden-2xl relative z-10 bg-white/[0.005]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center mb-golden-xl"
          >
            <div className="section-badge">团队协作</div>
            <h2 className="section-title">我们由谁驱动？</h2>
            <p className="section-subtitle">HamR 是一个融合了核心团队梦想与全球开源社区力量的温暖家园</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-golden-md">
            {team.map((member, i) => (
              ...
              >
                ...
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${member.color} flex items-center justify-center text-white mb-5 shadow-lg shadow-black/30 transition-transform duration-300 group-hover:scale-105`}>
                  {member.icon}
                </div>
                ...
                <p className="text-white/60 leading-relaxed text-sm font-semibold">{member.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-golden-2xl relative z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }} viewport={{ once: true }} className="text-center mb-golden-xl"
          >
            <div className="section-badge">发展历程</div>
            <h2 className="section-title">我们的发展历程</h2>
            <p className="section-subtitle">稳步向前，在隐私与爱心的指引下构筑产品功能矩阵</p>
          </motion.div>
          
          <div className="relative">
            {/* 时间轴中线发光渐变导轨 */}
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-primary-500 via-indigo-500 to-teal-500 opacity-20 -translate-x-1/2" />
            ...
            <div className="space-y-golden-md">
              {milestones.map((m, i) => (
                ...
                >
                  {/* 发光球体节点 */}
                  <div 
                    className={`absolute left-8 md:left-1/2 w-6 h-6 rounded-full border-4 border-dark-500 -translate-x-1/2 flex items-center justify-center z-10 transition-all duration-500 ${
                      m.active 
                        ? 'bg-gradient-to-br from-primary-500 to-indigo-500 shadow-glow-sm scale-110' 
                        : 'bg-dark-300 border-white/20'
                    }`} 
                  />
                  ...
                  <div className="w-full md:w-1/2 pl-16 md:pl-0 text-left">
                    <div className={`card-dark p-golden-md rounded-2xl relative overflow-hidden group border ${m.active ? 'border-primary-500/20' : 'border-white/5'}`}>
                      <div className="absolute -top-12 -right-12 w-24 h-24 rounded-full blur-2xl opacity-10 bg-primary-500 pointer-events-none" />
                      
                      <div className={`inline-block px-3 py-1 rounded-full text-xs font-bold font-mono border mb-3 ${
                        m.active 
                      ...
                      <p className="text-white/60 text-sm leading-relaxed font-semibold">{m.desc}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
      ...
      <section className="py-golden-2xl relative z-10 bg-white/[0.005]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h2 className="section-title">与我们建立连接</h2>
            <p className="section-subtitle">无论是建议、吐槽还是代码合并，我们随时倾听您的声音</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-golden-md">
            {[
              ...
              <a
                ...
                className="card-dark p-golden-md flex flex-col items-center group relative overflow-hidden border border-white/5"
              >
